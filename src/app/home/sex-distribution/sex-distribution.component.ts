...
import { SexDistributionService } from './sex-distribution.service';
@Component({
  selector: 'app-sex-distribution',
  templateUrl: './sex-distribution.component.html',
  styleUrls: ['./sex-distribution.component.scss'],
  providers: [SexDistributionService]
})
export class SexDistributionComponent implements OnInit {
  ...
  constructor(private mainPageService: SexDistributionService) { }
